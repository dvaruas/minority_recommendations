# This plot is to get the Disparate Visbility for synthetic static networks.
# Single plot
# ["Caltech36", "Reed98", "Haverford76", "Simmons81", "Swarthmore42"]
import os
import sys
...
if __name__ == "__main__":
    ...
    lower_limit = (-1.0/(1.0 - info["minority_fraction"]))
    upper_limit = (1.0/info["minority_fraction"])

    plt.plot([lower_limit, lower_limit], [-1, len(plot_data["x"])], color="black", linestyle="--")
    plt.plot([upper_limit, upper_limit], [-1, len(plot_data["x"])], color="black", linestyle="--")
    ...
    #plt.savefig(os.path.join("..", "dv_simmons.png"))
    plt.show()
